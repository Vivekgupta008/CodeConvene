...
class FAQTool:
    ...
    def __init__(self):
        self.faq_responses = {
            "what is CodeConvene.ai": "CodeConvene.AI is an AI-powered Developer Relations assistant that helps open-source communities by automating engagement, issue tracking, and providing intelligent support to developers.",
            ...
            "what platforms does CodeConvene.ai support": "CodeConvene.AI integrates with Discord, Slack, GitHub, and can be extended to other platforms. We use these integrations to provide seamless developer support across multiple channels.",
            "who maintains CodeConvene.ai": "CodeConvene.AI is maintained by an open-source community of developers passionate about improving developer relations and community engagement.",
            ...
            "how to get started": "To get started with CodeConvene.AI: 1) Check our documentation, 2) Join our Discord community, 3) Explore the GitHub repository, 4) Try contributing to open issues.",
            "what is langgraph": "LangGraph is a framework for building stateful, multi-actor applications with large language models. We use it to create intelligent agent workflows for our CodeConveneel automation."
        }
