...
class FAQHandler(BaseHandler):
    ...
    def __init__(self, bot=None):
        self.bot = bot
        self.faq_responses = {
            "what is CodeConvene.ai?": "CodeConvene.AI is an AI-powered Developer Relations assistant that helps open-source communities by automating engagement and issue tracking.",
            "how do i contribute?": "You can contribute by visiting our GitHub repo, checking open issues, and submitting pull requests.",
            "what platforms does CodeConvene.ai support?": "CodeConvene.AI integrates with Discord, Slack, GitHub, and Discourse to assist developers and maintainers.",
            "who maintains CodeConvene.ai?": "CodeConvene.AI is maintained by an open-source community of developers.",
