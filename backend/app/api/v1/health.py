...
@router.get("/health")
async def health_check(app_instance: "CodeConveneAIApplication" = Depends(get_app_instance)):
    """
...
async def discord_health(app_instance: "CodeConveneAIApplication" = Depends(get_app_instance)):
